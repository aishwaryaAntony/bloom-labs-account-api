...
exports.fetch_all_screens = async (req, res, next) => {
    try {
        ...
        let fetchScreenPermissions = await db.ScreenPermission.findAll({
            limit: limit,
            offset: offset,
            order: [['id', 'ASC']]
        })
...
exports.create_screen = async (req, res, next) => {
    try {
        ...
        let fetchScreenPermission = await db.ScreenPermission.findOne({
            where: {
                code: code
            }
        })
        ...
        let newScreenPermission = await db.ScreenPermission.create({
            code,
            name,
            status
        });
...
exports.update_screen = async (req, res, next) => {
    try {
        ...
        await db.ScreenPermission.update({
        ...
        fetchScreenPermission = await db.ScreenPermission.findOne({
            where: {
                id: fetchScreenPermission.id
            }
        })
