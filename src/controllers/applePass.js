...
exports.apple_pass = async (req, res, next) => {
    try {
        ...
        let find_member = await db.Member.findOne({
            where: {
                qr_code: qr_code
            }
        });
        ...
        console.log(moment(find_member.birth_date).format('MM/DD/YYYY'))
        ...
        pass.secondaryFields.add({ key: "dat", label: "DATE OF BIRTH", value: find_member.birth_date !== null ? moment(find_member.birth_date).format('MM/DD/YYYY') : "" });
